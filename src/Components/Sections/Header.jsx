        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center flex-wrap">
          ...
          <div className="hidden lg:flex flex-col items-center gap-4 w-full max-w-[700px] px-4">
            ...
            <nav className="flex gap-7 text-lg flex-wrap justify-center">
              ...
              <Link className="text-red-900 hover:text-green-600 hover:underline" to="/BestSeller">Best Seller</Link>
              <Link className="text-red-900 hover:text-green-600 hover:underline" to="/about">About</Link>
